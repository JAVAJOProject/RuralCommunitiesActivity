    ...
    return (
        ...
        <FormBox clipColor='yellow' formName='체험자 정보 수정'>
            <form onSubmit={updateMethod.handleSubmit(updateOnSubmit)} >
                ...
                <InputforMemberUpdate inputInfoData={inputForMemberUpdate} inputChange={handleUpdateOnChange} />

                <Buttonbtn type='reset' text='닫 기' style={{marginRight: '6.5rem'}} click={backA} />
