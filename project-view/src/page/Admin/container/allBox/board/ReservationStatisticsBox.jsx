...
export default function ReservationStatisticsBox() {
    ...
    return (
      <div>
      <ReservationStatisticsSearchBox searchData={handleCallbackForMemberList} />
        <br />
      <ReservationStatisticsBottomBox tableMemberData={reservationSearchData} resulltCnt={cntForReservation} />
      </div>
    );
  }