...
export default function MemberReservationSearchBox({searchData}) {
    ...
    return (
        ...
        <TopSearchBigBox categoryName={title} >
            <form onSubmit={onSubmitForTotalActivityInfoA}> 
                ...
                <SelectDate selectType='eventProgressStatus' selectChange={handleOnChange}/><br />
