    ...
    return (
        ...
        <div className='pageNumberContainerA'>
            <div className='pageNumberInnerA'>
                ...
                <RequestPageNumber click={requestNumber} requestPage={page} totalPage={ttlPage} isColor={isColor} setColor={setIsColor}/>
                <RequestPageNext click={nextNumber} requestPage={page} totalPage={ttlPage}/>
            </div>
        </div>
        </>
    );
