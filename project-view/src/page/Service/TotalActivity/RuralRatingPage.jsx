...
import RatingTopBanner from "./TopBanner/RatingTopBanner";
import RatingMiddleBox from "./MiddleBox/RatingMiddleBox";
import RatingCategoryBoxSet from "./CategoryBox/RatingCategoryBoxSet";
import RatingDataTable from "./TableBox/RatingDataTable";
...
export default function RuralRatingPage() {
  ...
  const [totalPageNo, setTotalPageNo] = useState(100);
  ...
  const handlePageChange = (pageNumber) => {
    setRequestPageNo(pageNumber);
  };

  const handlePrevPage = () => {
    if (requestPageNo > 1) {
      handlePageChange(requestPageNo - 1);
    }
  };
