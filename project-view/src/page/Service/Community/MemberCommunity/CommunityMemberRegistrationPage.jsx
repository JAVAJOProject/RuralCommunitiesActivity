...
const communityContentRegistrationApi = '/community/member/post/upload';
...
export default function CommunityMemberRegistrationPage() {
  ...
  const { registrationBtn, cancelBtn, pickImages, textareaInput, selectMemo } =
    defaultContents;
