...
export default function MemberReservationBox() {
  const [reservationForMemberSearchData, setReservationForMemberSearchData] =
    useState([]);
  ...
  return (
    <div>
      ...
      <br />
      <MemberReservationBottomBox
        tableMemberData={reservationForMemberSearchData}
        resulltCnt={cntForReservationMember}
      />
    </div>
  );
}
