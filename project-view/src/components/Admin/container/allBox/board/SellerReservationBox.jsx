...
export default function SellerReservationBox() {
  const [reservationForSellerSearchData, setReservationForSellerSearchData] =
    useState([]);
  ...
  return (
    <div>
      ...
      <br />
      <SellerReservationBottomBox
        tableMemberData={reservationForSellerSearchData}
        resulltCnt={cntForReservationSeller}
      />
    </div>
  );
}
