...
export default function ReservationStatisticsSearchBox({searchData}) {
    ...
    return (
        ...
        <TopSearchBigBox categoryName={title} >
            <form onSubmit={onSubmitForTotalActivityInfoA}> 
                ...
                <SelectDate selectType='month' selectChange={handleOnChange}/><br />
                <SelectDate selectType='seller' selectSido={totalActivityADTO.sido} selectChange={handleOnChange} /><br />
