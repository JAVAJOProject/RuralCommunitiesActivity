...
export default function TotalActivityInfoSearchBox({
  searchData,
  requestPage,
  setRequestPage,
  setTotalPage,
  ...
  const fetchData = async () => {
    try {
      ...
      const requestData = await fetchDataPOSTAndObj(
        `/admin/board/activity/select/${requestPage}`,
        totalActivityADTO
      );
      ...
      if (requestData !== undefined) {
        ...
        const [perPostPageNo, totalPostNo] = await fetchDataPOSTAndObj(
          `/admin/board/activity/selectActivityCount`,
          totalActivityADTO
        );
    ...
    <div>
      <TopSearchBigBox categoryName={title}>
        <form onSubmit={onSubmitForTotalActivityInfoA}>
          ...
          <SelectDate
            selectType="sigungu"
            selectSido={totalActivityADTO.sido}
            selectChange={handleOnChange}
          />
          <br />
          <SelectDate selectType="theme" selectChange={handleOnChange} />
          <br />
