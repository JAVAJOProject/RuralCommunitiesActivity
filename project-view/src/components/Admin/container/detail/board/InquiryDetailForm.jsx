...
export default function InquiryDetailForm({postId}) {
    ...
    return (
      ...
      <BoardFormBackgroundBox clipColor='yellow' formType='문의글 보기' >      
        ...
        <>
        <FormInnerBox  formType='1' formName={item.inquiryTitle} /><br />
        <FormInnerBox  formType='1' formName={item.inquiryContent} innerStyle={{height: '200px'}}/> <br />
        <FormInnerBox  formType='1' formName={item.inquiryA} innerStyle={{height: '200px'}}/> 
        </>
        ))) : (
        <FormInnerBox formType='1' formName='다시 조회해주세요'/>
            ...
            <Buttonbtn type='submit' text='수 정' click={handleModifyForMemberUpdate} style={{marginLeft: '0px'}} />
