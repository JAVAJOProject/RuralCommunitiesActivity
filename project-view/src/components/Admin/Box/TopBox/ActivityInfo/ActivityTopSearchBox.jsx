...
import './ActivityTopSearchBox.css';
...
export default function TopSearchBox() {
  ...
  return (
    <div>
        <div className="TopSearchBackgroundBox">
            <div className="TopCategoryName">
              <p>전체목록조회</p>
            </div>
            <div className="TopSearchLinnerBox">
                <ul>
                  <li>기간</li>
                  <li>지역</li>
                  <li>테마</li>
              ...
              <form method="get"  className='TopSearchForm'>  
               <SelectDate selectDate={SelectDateData} />
               <InputTest inputData={InputSelectData} /><br />

               <SelectDate selectDate={SelectRegionSido} />
               <SelectDate selectDate={SelectRegionSigungu} /><br />
               <SelectDate selectDate={SelectTheme} /><br />
              
               <InputTest inputData={InputSelectKeyword} /><br />
               <InputTest inputData={InputSelectCharge} />
