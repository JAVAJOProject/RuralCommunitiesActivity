...
import titleImg from '../../../../view_img/Service/community/community/memberTitle.jpg';
...
const defaultContents = {
  titles: {
    mainTitle: '빛길 트레커의 소통공간',
    subtitle: '빛길을 걷은 다른 트레커들이 궁금하지 않으세요?',
    imgSrc: titleImg,
  },
  ruleBoard: {
    imgSrc: speakerImg,
...
export default function RootLayoutMemberCommunity() {
