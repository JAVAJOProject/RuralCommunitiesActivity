...
import TotalBtnBox from '../totalActivityPage/Detail/buttons/TotalBtnBox';
// import DetailMapApi from '../totalActivityPage/Detail/map/DetailMapApi';
import { useNavigate } from 'react-router-dom/dist';
import RecActSellerInfoBox from './Detail/RecActSellerInfoBox';
...
export default function RecActDetailPage() {
  ...
  return (
    <div>
      ...
      <EventFirstBox defaultContents={firstBox} data={contents} />
