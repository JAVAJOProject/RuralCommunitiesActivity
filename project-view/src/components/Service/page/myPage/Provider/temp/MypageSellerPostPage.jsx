...
import MypageMypost from './post/MypageMypost';
  ...
  return (
    <>
      <CardListContentBox style={{ paddingBottom: '1rem' }}>
        <CardBoxTitleSet imgSrc={imgSrc} text={text} circleColor='#EEF5F8' isDarken={true} />
        {testContents.map((item) => {
          const { content, favoriteNum, viewingsNum } = item;
