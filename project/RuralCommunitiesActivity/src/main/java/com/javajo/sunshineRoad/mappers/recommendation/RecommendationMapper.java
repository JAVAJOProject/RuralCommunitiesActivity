...
//	public List<RecActivityInfoDTO> getTotalRecActivityCount(@Param("colName") String colName, @Param("startPostNo") int startPostNo, @Param("perPagePostNo") int perPagePostNo);
//	public List<RecTownInfoDTO> getTotalRecTownCount(@Param("colName") String colName, @Param("startPostNo") int startPostNo, @Param("perPagePostNo") int perPagePostNo);
