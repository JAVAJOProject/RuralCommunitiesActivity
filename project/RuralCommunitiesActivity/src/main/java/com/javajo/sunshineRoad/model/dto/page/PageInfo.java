package com.javajo.sunshineRoad.model.dto.page;
...
@NoArgsConstructor
@AllArgsConstructor
public class PageInfo { // 페이징 처리 클래스

	private int currentPage; // 현재 페이지
	private int pageLimit; // 한 페이지에 보여질 최대 페이지 개수
	private int listCount; // 전체 게시글 개수
	private int listLimit; // 한 페이지 당 최대 게시글 개수
