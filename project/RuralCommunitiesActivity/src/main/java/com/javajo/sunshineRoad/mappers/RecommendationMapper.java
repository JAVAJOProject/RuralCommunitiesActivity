...
public interface RecommendationMapper {
	...
	public List<RecActivityInfoDTO> keywordFilter(int recAKeywordId);
	...
	public List<RecActivityInfoDTO> getTotalRecActivityCount(@Param("startPostNo") int startPostNo, @Param("endPostNo") int endPostNo);
	public List<RecTownInfoDTO> getTotalRecTownCount(@Param("startPostNo") int startPostNo, @Param("endPostNo") int endPostNo);
