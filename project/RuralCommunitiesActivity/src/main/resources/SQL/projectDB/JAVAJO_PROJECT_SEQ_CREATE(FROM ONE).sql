...
BEGIN
    ...
    sql2 := 'CREATE SEQUENCE activity_customer_' || act_info_id || '_seq INCREMENT BY 1 MINVALUE 1 NOMAXVALUE START WITH 1 NOCACHE NOCYCLE';
...
BEGIN
    ...
    IF (e_status = 3) THEN
        ...
        EXECUTE IMMEDIATE sql1;
        sql2 := 'CREATE SEQUENCE event_winner_' || e_id || '_seq INCREMENT BY 1 MINVALUE 1 NOMAXVALUE START WITH 1 NOCACHE NOCYCLE';
        EXECUTE IMMEDIATE sql2;
    END IF;
END;
/
